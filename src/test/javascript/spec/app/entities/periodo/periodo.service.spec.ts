...
describe('Service Tests', () => {
    describe('Periodo Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Periodo(0, 'AAAAAAA', currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Periodo', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        data: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Periodo', async () => {
                const returnedFromService = Object.assign(
                    {
                        idConta: 'BBBBBB',
                        data: currentDate.format(DATE_FORMAT)
            ...
            it('should return a list of Periodo', async () => {
                const returnedFromService = Object.assign(
                    {
                        idConta: 'BBBBBB',
                        data: currentDate.format(DATE_FORMAT)
            ...
            it('should delete a Periodo', async () => {
