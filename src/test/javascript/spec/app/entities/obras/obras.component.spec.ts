...
import { ObrasComponent } from 'app/entities/obras/obras.component';
import { ObrasService } from 'app/entities/obras/obras.service';
import { Obras } from 'app/shared/model/obras.model';

describe('Component Tests', () => {
    describe('Obras Management Component', () => {
        let comp: ObrasComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ObrasComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.obras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
